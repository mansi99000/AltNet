...
class BasePolicy(BaseModel, ABC):
    ...
    def predict(
    ...
    ) -> Tuple[np.ndarray, Optional[Tuple[np.ndarray, ...]], Union[int, float, None]]:
        """
        ...
        with th.no_grad():
            actions, action_index = self._predict(observation, deterministic=deterministic, evaluation=evaluation)
        ...
        return actions, state, action_index
